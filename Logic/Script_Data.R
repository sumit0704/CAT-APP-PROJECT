...
setwd("C:\\Users\\CATAPP\\Logic")
if(file.exists(".\\Figs\\generated_graph.png")){
	file.remove()}	
		# modified this line 
...
library(pROC)
library(RJDBC)
inputdata=read.csv("C:/Users/CATAPP/Logic/Query Parameters.csv")
drv = JDBC("com.mysql.jdbc.Driver",
           "mysql-connector-java-5.1.36-bin.jar",
           identifier.quote="`")
dbhandle=dbConnect(drv, "jdbc:mysql://localhost:3306/catapp", "root", "vibscatapp")
inputdata=read.csv("C:/Users/CATAPP/Logic/Query Parameters.csv")
querydata=paste0("select b.chemical_id,b.thousandx,b.hunderedx,b.tenx,b.onex From processed_readings_header a join processed_readings_details b on a.entity_id=b.header_id join chemical_cas_concawe_mapping c on c.name=b.chemical_id where c.cas_number='", inputdata[[1]], "' and a.cellline='", inputdata[[2]], "' and a.timepoint='", inputdata[[4]], "' and a.phenotype='", inputdata[[3]], "'")
w2=dbGetQuery(dbhandle,querydata)
print(w2)
print(querydata)
query2=paste0("select b.control_tag,b.value From processed_readings_header a join vehicle_control b on a.entity_id=b.header_id where a.cellline='", inputdata[[2]], "' and a.timepoint='", inputdata[[4]], "' and a.phenotype='", inputdata[[3]], "'")
dmso=dbGetQuery(dbhandle,query2)
print(dmso)
print(query2)
...
for (i in (1:numchem)){ 
	file_name = paste(".\\Figs\\generated_graph", i, ".png", sep="")
